...
import BtnVolume from "../../assets/volume.svg";
import BtnShuffle from "../../assets/shuffle.svg";
import BtnBackward from "../../assets/backward.svg";
import BtnPlay from "../../assets/play.svg";
import BtnPause from "../../assets/pause.svg";
import BtnForward from "../../assets/forward.svg";
import BtnRepeat from "../../assets/repeat.svg";
    ...
    return (
      <Container>
        ...
        <Progress>
          <Controls>
            <button>
              <img src={BtnShuffle} alt="Shuffle" />
            </button>
            <button>
              <img src={BtnBackward} alt="Backward" />
            </button>
            <button>
